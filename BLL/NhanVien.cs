...
namespace Restaurant_Management.BLL
{
    class NhanVien
    {
        ...
        public bool Insert(string hoten, string gtinh, DateTime ngsinh, string dchi, string cmnd ,string vitri, string avatar, string sdt)
        {
            ...
            int rs = Provider.Ins.ExcuteNonQuery(query, new object[] { getMaNVnext(), hoten, gtinh, ngsinh.ToString("yyyy-MM-dd HH:mm:ss"), dchi, cmnd, "1" , vitri, avatar , sdt});
            return (rs > 0);
        }
        public bool Update(string id, string hoten, string gtinh, DateTime ngsinh, string dchi, string cmnd, string isactive, string vitri, string avatar, string sdt)
        {
            ...
            int rs = Provider.Ins.ExcuteNonQuery(query, new object[] { hoten, gtinh, ngsinh.ToString("yyyy-MM-dd HH:mm:ss"), dchi , cmnd , isactive, vitri , avatar , sdt, id});
            return (rs > 0);
        }
